...
const Post = ({ addToCart, product, variants, clearCart, buyNow }) => {
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                  ...
                  {Object.keys(variants).includes("Black") &&
                    Object.keys(variants["Black"]).includes(size) && (
                      <button
                        ...
                        className={`mr-1 border-2  w-5 h-5 rounded-full bg-black ${
                  ...
                  {Object.keys(variants).includes("White") &&
                    Object.keys(variants["White"]).includes(size) && (
                      <button
                        ...
                        className={`mr-1 border-2  w-5 h-5 rounded-full bg-white ${
                  ...
                  {Object.keys(variants).includes("Blue") &&
                    Object.keys(variants["Blue"]).includes(size) && (
                      <button
                        ...
                        className={`mr-1 border-2  w-5 h-5 rounded-full bg-blue-500 ${
                  ...
                  {Object.keys(variants).includes("Red") &&
                    Object.keys(variants["Red"]).includes(size) && (
                      <button
                        ...
                        className={`mr-1 border-2  w-5 h-5 rounded-full bg-red-500 ${
                  ...
                  {Object.keys(variants).includes("Purple") &&
                    Object.keys(variants["Purple"]).includes(size) && (
                      <button
                        ...
                        className={`mr-1 border-2  w-5 h-5 rounded-full bg-purple-500 ${
                          color === "Purple"
                            ? "border-black"
                            : "border-gray-300"
                        }`}
              ...
              <div className="flex mb-6">
                ...
                <button
                  ...
                  className="flex ml-4 text-white bg-indigo-500 border-0 py-2 px-2 focus:outline-none hover:bg-indigo-600 rounded"
                >
                  Add to Cart
                </button>
              ...
              <div className="pin">
                <input
                  type="text"
                  className="border-black border-2 outline-zinc-900 mr-5"
                  onChange={onChangePin}
                />
                <button
                  onClick={checkAvailability}
                  placeholder="Enter your pincode"
                  className="text-white bg-indigo-500 border-2 py-2 px-2 focus:outline-none hover:bg-indigo-600 rounded"
                >
                  Check
                </button>
...
export async function getServerSideProps(context) {
  ...
  return {
    props: {
      ...
      variants: await JSON.parse(JSON.stringify(colorSizeSlug)),
    },
  };
}
